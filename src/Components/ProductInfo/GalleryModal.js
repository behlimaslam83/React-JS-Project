...
class GalleryModal extends Component {
  ...
  proceedDelete = (params) => {
    if (params) {
      this.deleteModalRecord(this.state.prod_gy_info_id);
    }else{
  ...
  galleryModalRecord=(id, desc)=>{
    this.setState({ prod_gy_info_id : id, mode: '', product_desc: desc});
  }
  ...
  handleSubmit(event){
    ...
    var url = '';
      ...
      url = insertUrl + '?prod_gy_info_id='+ this.state.prod_gy_info_id;
      ...
      <div>
        ...
        <Modal.Header closeButton className="">
          <Modal.Title id="modalTitle">
            Gallery {this.state.product_desc != '' ? '('+this.state.product_desc+')'  : ''}
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Row>
                  ...
                  <Col>   
                    ...
                    <Form.Group>
                      <div className="previewComponent">
                        <Form.Control className="fileInput" type="file" onChange={(e)=>this._handleImageChange(e)} />
              ...
              <SnapBarError 
                ...
                <WindowPanel rawHtml={
                  <div className="windowContent">
                    <ServerTable renderView={this.state.galleryrenderTable} columns={columns} url={`${url+`?prod_gy_info_id=`+this.state.prod_gy_info_id}`} options={options} addme={$button} bordered hover updateUrl>
                    {
