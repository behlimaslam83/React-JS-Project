                    ...
                    <Form.Group> 
                      ...
                      <Form.Control as="select" value={setValue.item_filter_type} name="item_filter_type" onChange={this.stateChanges}>
                        ...
                        {filterlov.map((data,i) => (
                          <option value={data.desc} key={i}>{data.desc}</option>
                        ))}
                      </Form.Control>
                    </Form.Group>
                  </Col>
                    ...
                    case 'actions':
                      return (
                        <div className="form-control-sm" style={{ textAlign: 'center' }}>
                          ...
                          <Dropdown.Item onClick={() => self.editpriceModalRecord(row.item_filter_id)}><FontAwesomeIcon icon={faEdit} /> Edit</Dropdown.Item>
